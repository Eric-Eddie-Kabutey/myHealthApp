...
function SuspendDoctor({open, close}:{open:boolean, close: ()=>void}) {
    return (
        <Dialog open={!!open} onOpenChange={()=>close()}>
            ...
            <p className='text-center w-[200px]'>You have successfully suspended this Doctor.</p>
            <br />
            </DialogContent>
        </Dialog>
