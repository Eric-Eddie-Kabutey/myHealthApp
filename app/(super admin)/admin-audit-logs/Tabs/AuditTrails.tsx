...
const logs = [
    {
        ...
        details: "Modified dosage for Patient ID: P001234",
        ip: "192.168.1.45",
        severity: "High",
    },
    {
        ...
        details: "Updated permissions for Nurse role",
        ip: "192.168.1.12",
        severity: "Medium",
    }
]
                    ...
                    <tbody>
                        {logs.map((log, idx) => (
                            <tr key={idx} className="border-b">
                                ...
                                <td className="p-3">
                                    <span
                                        className={`px-3 py-1 rounded text-xs font-medium ${log.severity === "High"
