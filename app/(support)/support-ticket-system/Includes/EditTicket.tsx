...
function EditTicket({ open, close }: { open: boolean, close: () => void }) {
    return (
        <Dialog open={open} onOpenChange={() => close()}>
            <DialogContent className="main-content sm:w-[400px] flex flex-col items-center gap-3">
                <DialogTitle />
                <p className="font-[500] text-lg">Edit Ticket</p>
                ...
                <Button className='w-full rounded h-10 my-2'>Update Ticket</Button>
            </DialogContent>
        </Dialog>
    )
}
