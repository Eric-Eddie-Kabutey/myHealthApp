        ...
        <div>
            <main className="min-h-[100dvh] h-auto flex flex-col items-center">
                <Hero className={`h-[650px]`} content={<div className='size-full flex flex-col pb-[2rem] items-center justify-end gap-3 bg-emerald-50/20 text-center relative'>
                    <video src="https://cdn.pixabay.com/video/2022/11/16/139365-772278357_large.mp4" loop playsInline autoPlay muted className="size-full object-cover"></video>
                    <div className="size-full flex flex-col items-center  absolute bg-gradient-to-r from-black/50 text-white">
                        <section className="w-full h-full xl:w-[1200px] flex items-end pb-[5rem]">
                            <div className="min-w-[370px] flex flex-col gap-3 text-left">
                                ...
                                <p>
                                    Discover a whole-person cardiometabolic program that helps people with diabetes enjoy healthier lives.
                                </p>
                ...
                <section className="w-full bg-white z-10 flex flex-col items-center gap-5 py-20">
                    <div className="xl:w-[1200px] flex flex-col items-center gap-6">
                        ...
                        <h1 className="text-4xl font-bold text-[#351F65] text-center leading-tight">
                            See how high-quality care and a personalized experience work together to deliver better outcomes.
                        </h1>
                        ...
                        <div className="w-[800px] py-[1rem] grid grid-cols-2 gap-20">
                            ...
                            <div className="flex flex-col justify-center gap-2">
                                <h1 className="text-3xl font-bold leading-7.5 text-indigo-950">Dedicated, provider-led care teams build lasting relationships</h1>
                                <ul className="list-disc pl-5 mt-2 space-y-1 text-base text-gray-700">
                                    ...
                                    <li>Alert response coaches offer real-time support for out-of-range readings</li>
                                    <li>Providers trained in chronic condition management offer additional level of support</li>
                                </ul>
                            </div>
                        </div>
                        <div className="w-[800px] py-[1rem] grid grid-cols-2 gap-20">
                            <div className="flex flex-col justify-center gap-2">
                                <h1 className="text-3xl font-bold leading-7.5 text-indigo-950">Data-driven, personalized content drives sustainable change</h1>
                                <ul className="list-disc pl-5 mt-2 space-y-1 text-base text-gray-700">
                                    <li>Cellular-connected blood glucose meter and unlimited test strips remove barriers to healthy habits</li>
                                    <li>Dynamic content delivers actionable tips to help people improve their health</li>
                        ...
                        <div className="w-[800px] py-[1rem] grid grid-cols-2 gap-20">
                            ...
                            <div className="flex flex-col justify-center gap-2">
                                <h1 className="text-3xl font-bold leading-7.5 text-indigo-950">
                                    The right support at the right time creates a more valuable experience
                                </h1>
                                <ul className="list-disc pl-5 mt-2 space-y-1 text-base text-gray-700">
                                    <li>Digital health interventions on meter and app reach people when they are most likely to engage</li>
                                    <li>Integrated mental health offers support for commonly connected conditions, like depression</li>
                                    <li>Proactive outreach connects high-risk members with providers</li>
                                    <li>Simple, seamless app experience spans a person’s entire health journey</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <section className="w-full bg-indigo-950 text-white z-10 py-20">
                    <div className="xl:w-[1200px] mx-auto px-6 flex flex-col gap-12 items-center">
                        <h1 className="text-4xl lg:w-[800px] font-bold text-center leading-tight">
                            Our diabetes approach delivers long-term results. We guarantee it.
                        </h1>
                        <aside className="w-full grid grid-cols-3 gap-5">
                            <div className="flex gap-4 items-start">
                                <i className="fa fa-dollar text-2xl text-indigo-400" />
                                <div className="flex flex-col">
                                    <h3 className="text-lg font-semibold text-white">100% fees at risk</h3>
                            ...
                            <div className="flex gap-4 items-start">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-sm text-indigo-200">
                                        We help people achieve meaningful results that last. Participants reduced their A1c by 2.1% in 3 months, then sustained their new level for 5+ years<sup>2</sup>
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-4 items-start">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-sm text-indigo-200">
                                        Program participants who also engaged with our digital mental health program saw 80+% greater improvement in blood glucose levels<sup>3</sup>
                                    </p>
                                </div>
                            </div>
                        </aside>
