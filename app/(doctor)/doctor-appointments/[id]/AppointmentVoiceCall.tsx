...
import { BookOpen, FileChartLine, Mic, MicOff, Phone, Search, Video, VideoOff } from 'lucide-react';
        ...
        <aside className="size-full flex flex-col items-center justify-center p-4">
            <div className="size-full rounded-2xl bg-[#1E2332] flex flex-col items-center text-white">
                <div className="size-full flex flex-col items-center justify-center gap-4">
                    ...
                    <Button className='rounded gap-2 w-fit'><Phone className='size-4'/>Start Call</Button>
                </div>
                <div className="py-3 flex justify-center gap-3">
                    <button className="size-10 rounded-full border border-red-500 flex items-center justify-center bg-red-500 text-white"><MicOff className='size-5'/></button>
                </div>
            </div>
        </aside>
    </div>
